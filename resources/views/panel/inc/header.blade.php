				...
				<ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void(0);" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{route('profile.index')}}">Hesap Görüntüle</a></li>
<li><a href="{{ route('profile.edit', auth()->user()->id) }}">Hesap Düzenle</a></li>
				...
				<div class="copyright">
					<p>DLL Teknoloji Müşteri Yönetim Sistemi<br/>© 2024 Tüm Hakkı Saklıdır</p>
					<p class="op5">Made with <span class="heart"></span> by Can TÜRK</p>
				</div>
			</div>
        </div>
        <!--**********************************
